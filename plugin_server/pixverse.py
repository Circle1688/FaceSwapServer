...
def pixverse_upload_image(image_path):
    try:
        ...
        server_logger.info("[PixVerse] Uploading image...")
        ...
        server_logger.info(f"[PixVerse] Uploaded image failed. {e}")
        return False, None
...
def pixverse_image_to_video(img_id, args):
    try:
        ...
        server_logger.info(f"[PixVerse] Generation failed. {rsp}")
        return None
    except Exception as e:
        server_logger.info(f"[PixVerse] Generation create failed. {e}")
        return None
...
def pixverse_get_result(video_id):
    while True:
        try:
            ...
            server_logger.info(f"[PixVerse] Get status failed. {e}")
            return False, None
...
def download_video(url, save_path):
    try:
        ...
        server_logger.info(f"[PixVerse] Download Video Failed. {e}")
        return False
